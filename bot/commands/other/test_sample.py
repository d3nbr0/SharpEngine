...
#     add_button(button) - добавляет новую кнопку
#     add_buttons(buttons) - добавляет новые кнопки (список)
#     add_button_line() - переносит все кнопки на новую строку
...
#
#       button =>
#           1. string - обычная кнопка с цветом default
#           2. dict ({'text': 'текст', 'color': 'цвет'}) - настраиваемая кнопка
